...
site_no='IFP_gen_USGS_flowdata_6000'
...
g = 9.81
rho = 1000
turb_cap = 0 #Turbine nameplate capacity in MW '''Narrows 1 12 MW''' '''IFP(Lower) 8.3 MW'''
diff_m = 30 #ft '''263 ft for Yuba River Dam''' '''19ft IFP (lower)'''

'''
1 ft = 0.3048m # Ft to m conversion
'''

flow_info = pd.read_excel(r'C:\Work\My_Code\scaled_hydropower.xlsx')
...
if (op == 'From File'):
    ...
    maxflow = 0.028316846591999675*6000
