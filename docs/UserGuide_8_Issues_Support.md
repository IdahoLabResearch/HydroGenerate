...
- **Search existing issues**: Your question may already be answered in [GitHub Issues](https://github.com/IdahoLabResearch/HydroGenerate).
...
For GitHub-related platform issues (e.g., account problems, repository access), contact [GitHub Support](https://docs.github.com/en/support/contacting-github-support) directly.
...
2. If it’s new, [open an issue](https://github.com/IdahoLabResearch/HydroGenerate) and fill out the template completely:
...
- [GitHub Docs: Creating an Issue](https://docs.github.com/en)
