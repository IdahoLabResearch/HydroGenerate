...
def api_code(site_no,begin_date,end_date):
    '''
...
site_no='04099000' #Mottville
begin_date = '2017-12-31'
end_date = '2019-12-31'
request=''
url = api_code(site_no,begin_date,end_date)
...
filename="C:\Work\My_Code\Files\{}_{}.csv".format(site_no,begin_date)
